...
//        }
      ...
      if let lesson = student.lesson {
        ...
        if let sports = lesson.sport {
          sportControl.selectedSegmentIndex = sports == "ski" ? 0 : 1
        }
...
//        }
    ...
    @IBAction func phoneAction(sender: UIButton) {
        ...
        UIApplication.shared.open(phoneURL!, options: convertToUIApplicationOpenExternalURLOptionsKeyDictionary(Dictionary()), completionHandler: nil)
    }
